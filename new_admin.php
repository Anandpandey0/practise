                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Add New Admin</p>
                                    ...
                                    <form class="mx-1 mx-md-4" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <label class="form-label" for="form3Example4c">Admin Password</label>
                                            </div>
                                        </div>
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <i class="fas fa-lock fa-lg me-3 fa-fw"></i>
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="password" id="form3Example4c" class="form-control" name="re_password" />
                                                <label class="form-label" for="form3Example4c">Re Enter Admin Password</label>
                                            </div>
                                        </div>
